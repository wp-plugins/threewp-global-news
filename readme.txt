...
If you want to display all news items expanded (even read items), edit the css file.
...
1. Menu item in dashboard widget
1. Global news
1. Global news with an item minimized
1. Adding news with item being previewed
1. Rest of settings for adding news
1. Editing news. Selected news items are about to be deleted.
1. Settings
1. Uninstall
